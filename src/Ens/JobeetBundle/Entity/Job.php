...
class Job
{
    ...
    /**
     * permet de stocker le fichier à uploader
     * @var File
     */
    public $file;
	...
	/**
	 * permet de remodeler la nouvelle url gÃ©nÃ©rÃ©e
    ...
    /**
     * défini l'expiration d'une offre
     * @ORM\PrePersist
     */
	...
	/**
	 * génère un jeton aléatoire (avant qu'une offre soit enregistré)
	 */
	...
	/**
	 * retourn si l'offre est expirée
	 * @return boolean
	 */
	...
	/**
	 * publie l'annonce en la notant comme activée
	 */
	...
	/**
	 * méthode pour les tests (formulaire)
	 * @return boolean
	 */
