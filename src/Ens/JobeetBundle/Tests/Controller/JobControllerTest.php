...
{
	/**
	 * obient la dernière offre de programming
	 */
	...
	/**
	 * soumet un formulaire et valide sa création puis redirige vers la page d'aperçu
	 * test ensuite que l'annonce n'est pas encore publiée
	 * 
	...
	/**
	 * création d'offre et redirige vers la nouvelle offre
	...
	/**
	 * retourne une offre en fonction de la valeur de l'intitulé
	 * @param int $position
	 */
